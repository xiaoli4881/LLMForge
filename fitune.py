...
#   Low-Rank Adaptation (LoRA) via PEFT and HuggingFace Transformers.
#   It supports JSON/JSONL datasets, automatic checkpoint recovery,
...
def train(
    ...
    assert base_model, "Error: Please specify --base_model."
    ...
    def generate_and_tokenize_prompt(data_point):
        full_prompt = prompter.generate_prompt(
            data_point["human"], data_point["assistant"]
        )
